            ...
            <div className={cx("container")}>
                <div className={cx("footer-columns")}>
                    <div className={cx("footer-column")}>
                        <h2 className={cx("footer__main-title")}>Российский национальный молодежный симфонический оркестр</h2>
                    </div>
                    <div className={cx("footer-column")}>
                        <div className={cx("footer-menu__items")}>
                            <div className={cx("footer-menu__item")}>
                                ...
                                <ul className={cx("ul-nostyle")}>
                                    <li><a href="#">Состав оркестра</a></li>
                                    <li><a href="#">Дирижеры оркестра</a></li>
                                    <li><a href="#">Солисты и ведущие сезона</a></li>
                    ...
                    <div className={cx("footer-column")}>
                        <div className={cx("footer-menu__items")}>
                            <div className={cx("footer-menu__item")}>
                                ...
                                <ul className={cx("ul-nostyle")}>
                                    <li><a href="#">Календарь концертов</a></li>
                            ...
                            <div className={cx("footer-menu__item")}>
                                ...
                                <ul className={cx("ul-nostyle")}>
                                    ...
                                    <li><a href="#">Фото</a></li>
                                    <li><a href="#">Онлайн-трансляция</a></li>
                    ...
                    <div className={cx("footer-column")}>
                        <div className={cx("footer-contacts")}>
                            ...
                            <p>
                                Концертный зал <nobr>Филармония–2</nobr><br/>
                            ...
                            <p>
                                Общие вопросы<br/>
                                <a className={cx("link")} href="mailto:info@rnmso.ru">info@rnmso.ru</a>
                            </p>
                            <p>
                                Пресса<br/>
                                <a className={cx("link")} href="mailto:pr@rnmso.ru">pr@rnmso.ru</a>
                            </p>
                        </div>
                    </div>
                </div>
                <div className={cx("footer-bottom")}>
                    <div className={cx("footer-bottom__links")}>
                        <a href="#"><img src="images/dest/logo-small-w.svg" alt=""/></a>
                        <a href="#"><img src="images/dest/logo-footer-1.svg" alt=""/></a>
                        <a href="#"><img src="images/dest/logo-footer-2.svg" alt=""/></a>
                    </div>
