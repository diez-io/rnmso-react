    ...
    return(
        <header className={cx("header")}>
            <picture className={cx("header__banner")}>
                <source srcSet="images/dest/main/banner-main-mob.png" media="(max-width: 991px)"/>
                ...
                <div className={cx("d-flex", "align-center", "header__top")}>
                    ...
                    <nav className={cx("menu-main")}>
                        <ul className={cx('ul-nostyle')}>
                            <li className={cx("menu-main__item")}><Link href="#">оркестр</Link></li>
                            <li className={cx("menu-main__item")}><Link href="/calendar">афиша</Link></li>
                            <li className={cx("menu-main__item")}><Link href="#">конкурс</Link></li>
                            <li className={cx("menu-main__item")}><Link href="#">фото и видео</Link></li>
                            <li className={cx("menu-main__item")}><Link href="#">информация</Link></li>
                        </ul>
                    </nav>
                    <div className={cx("header__links")}>
                        <a className={cx("header__links-lang")} href="#">Eng</a>
                        <a className={styles["header__links-search"]} href="#">
                            <img className={styles["icon-search"]} src="images/dest/icons/search-icon.svg"/>
                        </a>
                    </div>
                </div>
